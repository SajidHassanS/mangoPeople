      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-center max-w-2xl mx-auto mb-10">
            Welcome to Mango People, where we serve the finest dishes made with
            love and passion. Our mission is to offer you an unforgettable
            dining experience by blending exquisite flavors, fresh ingredients,
        ...
        <div className="flex flex-col md:flex-row items-center justify-around mb-10">
          ...
          >
            ...
            <p className="mb-6">
              ...
              Established in 2023, we have quickly become a favorite spot for
            ...
            <p className="">
              ...
              to delivering top-quality service and making your visit to Mango
              People a memorable one.
            </p>
          </motion.div>
        </div>
